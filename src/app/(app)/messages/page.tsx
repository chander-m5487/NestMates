...
export default function MessagesPage() {
  ...
  const getChatIcon = () => <Home className="w-4 h-4" />;
      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Your conversations about active listings
          </p>
        </div>
        ...
        {isLoading ? (
          ...
          <Card className="p-12 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Browse listings and message a host or roommate seeker to get started.
            </p>
              ...
              >
                <Card
                  className={`p-4 hover:shadow-md transition-shadow cursor-pointer relative ${
                    !chat.isActive ? 'bg-red-50 border-red-200 opacity-80' :
                    ...
                    <div className="relative">
                      <Avatar className="w-12 h-12">
                        <AvatarFallback className="bg-primary-100 text-primary-700">
                          {(chat.otherUser.displayName || chat.otherUser.uniqueUserId)
                            .charAt(0)
                            .toUpperCase()}
                        </AvatarFallback>
                      </Avatar>
                      {/* Unread dot indicator */}
                      {chat.unreadCount > 0 && chat.isActive && (
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-1">
                        <div className="flex items-center gap-2 min-w-0">
                          ...
                          {!chat.isActive && (
                            <span className="shrink-0 text-[10px] font-semibold px-1.5 py-0.5 rounded-full bg-red-100 text-red-600">
                              Listing deleted
                            </span>
                          )}
                        </div>
      ...
      {selectedChat && (
        <ChatPanel
          ...
          recipientName={
            ...
            selectedChat.otherUser.uniqueUserId
          }
          postExpiresAt={selectedChat.post.expiresAt}
          postIsActive={selectedChat.post.isActive}
        />
      )}
    </>
  );
